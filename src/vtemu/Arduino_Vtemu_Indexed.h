...
#ifndef _ARDUINO_VTEMU_INDEXED_H_
#define _ARDUINO_VTEMU_INDEXED_H_

#include "../Arduino_GFX.h"

#define COLOR_IDX_SIZE 256

class Arduino_Vtemu_Indexed : public Arduino_GFX
{
public:
  Arduino_Vtemu_Indexed(int16_t w, int16_t h, Arduino_G *output, int16_t output_x = 0, int16_t output_y = 0, uint8_t mask_level = 0);
  ~Arduino_Vtemu_Indexed();
...
#endif // _ARDUINO_VTEMU_INDEXED_H_
